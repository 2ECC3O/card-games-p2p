...
import {
  addBot, addPlayer, addSpectator, applyAction, cleanName, hostTick, IDLE_MS, isBot, maskFor, removePlayer, setConnected, startGame, TURN_MS,
} from '../engine/slaveEngine';
...
type Msg =
  ...
  | { t: 'leave' | 'ping' | 'pong' | 'promote' | 'refuse' }

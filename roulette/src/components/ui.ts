/** Shared button looks: one accent (red), everything else neutral. */
const base =
...
export const button = {
  primary: `${base} bg-red-400 text-red-950 hover:bg-red-300`,
...
export const field =
  ...
  'placeholder:text-slate-500 hover:border-white/20 focus:border-red-400 focus:ring-2 focus:ring-red-400/25';
